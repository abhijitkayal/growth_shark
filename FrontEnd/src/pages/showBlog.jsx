...
export default function Blogs() {
  ...
  return (
  <div className="min-h-screen relative overflow-hidden bg-white py-5">
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <h1 className="text-4xl md:text-5xl font-extrabold text-center text-black tracking-tight">
      Latest Blogs
    </h1>
